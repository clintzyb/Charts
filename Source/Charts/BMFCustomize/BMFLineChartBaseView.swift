...
open class BMFLineChartBaseView: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    internal override func initialize()
    {
        ...
        #if !os(tvOS)
            _pinchGestureRecognizer = NSUIPinchGestureRecognizer(target: self, action: #selector(BMFLineChartBaseView.pinchGestureRecognized(_:)))
        ...
        else if recognizer.state == NSUIGestureRecognizerState.ended || recognizer.state == NSUIGestureRecognizerState.cancelled
        {
            ...
            if _isDragging
            {
                if recognizer.state == NSUIGestureRecognizerState.ended && isDragDecelerationEnabled
                {
                    ...
                    _decelerationDisplayLink = NSUIDisplayLink(target: self, selector: #selector(BMFLineChartBaseView.decelerationLoop))
