...
class BMFLineChartRenderer: LineChartRenderer {
    
    
    open override func drawDataSet(context: CGContext, dataSet: ILineChartDataSet)
    {
    ...
    open  override func drawLinearFill(context: CGContext, dataSet: ILineChartDataSet, trans: Transformer, bounds: XBounds)
    {
...
// 朱元斌2017-09-11 添加
extension BMFLineChartRenderer{
    ...
    open  func drawCubicBezierForSegment(context: CGContext, dataSet: ILineChartDataSet)
    {
        ...
        dataSet1.mode = tempDataSet.mode
        dataSet1.circleRadius = tempDataSet.circleRadius
        dataSet1.fillAlpha = tempDataSet.fillAlpha
        dataSet1.fill = tempDataSet.fill
        dataSet1.drawFilledEnabled  = tempDataSet.drawFilledEnabled
        dataSet1.drawValuesEnabled = tempDataSet.drawValuesEnabled
